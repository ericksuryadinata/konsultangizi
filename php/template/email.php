...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Oswald:400,700,400italic" rel="stylesheet" type="text/css" />
    <!--<![endif]-->
    <style type="text/css">
        body {
...
<body class="no-padding" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;">
    <!--<![endif]-->
    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #ebebec;" cellpadding="0" cellspacing="0" role="presentation">
        <tbody>
            <tr>
                <td>
                    <div role="banner">
                        ...
                        <div class="header" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);" id="emb-email-header-container">
                            ...
                            <div class="logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;Margin-top: 6px;Margin-bottom: 20px;color: #41637e;font-family: Avenir,sans-serif;Margin-left: 20px;Margin-right: 20px;" align="center">
                                <div class="logo-center" align="center" id="emb-email-header"><img style="display: block;height: auto;width: 100%;border: 0;max-width: 150px;" src="cid:header" alt="" width="150" /></div>
                            </div>
                            <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
                        </div>
                    </div>
                    <div>
                        <div style="background-color: #363f49;">
                            <div class="layout one-col stack" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                                <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
                                    <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-full-width" style="background-color: #363f49;"><td class="layout__edges">&nbsp;</td><td style="width: 600px" class="w560"><![endif]-->
                                    ...
                                    <div class="column" style="text-align: left;color: #2b343f;font-size: 17px;line-height: 26px;font-family: Courier New,Courier,monospace;">
                                        ...
                                        <div style="Margin-left: 20px;Margin-right: 20px;">
                                            <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                                <h1 style="Margin-top: 0;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: #363f49;font-size: 40px;line-height: 47px;font-family: Oswald,Avenir Next Condensed,Arial Narrow,MS UI Gothic,sans-serif;">Konsultasi dari {{nama}}</h1>
                                            </div>
                                        </div>
                        ...
                        <div class="layout one-col fixed-width stack" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                            <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #15ab49;">
                                <!--[if (mso)|(IE)]><table align="center" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-fixed-width" style="background-color: #15ab49;"><td style="width: 600px" class="w560"><![endif]-->
                                <div class="column" style="text-align: left;color: #2b343f;font-size: 17px;line-height: 26px;font-family: Courier New,Courier,monospace;">
                        ...
                        <div class="layout one-col fixed-width stack" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                            <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #ffffff;">
                                ...
                                <div class="column" style="text-align: left;color: #2b343f;font-size: 17px;line-height: 26px;font-family: Courier New,Courier,monospace;">
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                            <p style="Margin-top: 0;Margin-bottom: 0;">Nama&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  : {{nama}}</p>
                                            <p style="Margin-top: 20px;Margin-bottom: 0;">Telepon&nbsp; &nbsp; &nbsp; &nbsp;: {{telepon}}</p>
                                            <p style="Margin-top: 20px;Margin-bottom: 0;">Usia&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : {{usia}}</p>
                                            <p style="Margin-top: 20px;Margin-bottom: 0;">Jenis Kelamin&nbsp;: {{jenisKelamin}}</p>
                                            <p style="Margin-top: 20px;Margin-bottom: 0;">Konsultasi&nbsp; &nbsp; :</p>
                                            <p style="Margin-top: 20px;Margin-bottom: 0;">{{konsultasi}}</p>
                                        </div>
                                    </div>
                        ...
                        <div style="background-color: #3d4853;background: 0px 0px/auto auto repeat url(https://i1.createsend1.com/ei/t/55/A5D/1C4/002745/csfinal/pattern1.png) #3d4853;background-position: 0px 0px;background-image: url(https://i1.createsend1.com/ei/t/55/A5D/1C4/002745/csfinal/pattern1.png);background-repeat: repeat;background-size: auto auto;">
                            <div class="layout one-col stack" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                                <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
                                    <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-full-width" style="background: 0px 0px/auto auto repeat url(https://i1.createsend1.com/ei/t/55/A5D/1C4/002745/csfinal/pattern1.png) #3d4853;background-position: 0px 0px;background-image: url(https://i1.createsend1.com/ei/t/55/A5D/1C4/002745/csfinal/pattern1.png);background-repeat: repeat;background-size: auto auto;background-color: #3d4853;"><td class="layout__edges">&nbsp;</td><td style="width: 600px" class="w560"><![endif]-->
                                    <div class="column" style="text-align: left;color: #2b343f;font-size: 17px;line-height: 26px;font-family: Courier New,Courier,monospace;">

                                        <div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;" align="center">
                                            <img class="gnd-corner-image gnd-corner-image-center gnd-corner-image-top" style="border: 0;display: block;height: auto;width: 100%;max-width: 900px;" alt="" width="600" src="cid:image-1" />
                                        </div>
